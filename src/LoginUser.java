...
public class LoginUser  {
        ...
        while(option != 4){
            ...
            switch(option){
                ...
                case 1:
                    ...
                    System.out.println();
                    System.out.printf("%5s %40s %30s ", user_in.getId() ,user_in.getName(), user_in.getType());
                    System.out.println();
                    break;

                case 2:
                    for(Project project : user_in.projects){
                        project.showInfo();
                    }
                    break;
                case 3:
                    for(Task task : user_in.tasks){
                        task.showInfo();
    ...
    public void login(List<Project> projects, List<User> users, Indices indices){
        String namet;       
        String descrt;         
        int id_aux;
        String namep;
            ...
            switch(option){
                case 1:
                    try{
                        ...
                        User user1 = new User(indices.id, name, type, username, password, question, answer);
                    ...
                    try{
                        ...
                        for(int i = 0; i < projects.size(); i++){
                            if(id_aux == projects.get(i).getId()){
                                Task task = new Task(indices.id_t, namet, descrt,StringToDateRange(date_start1, date_end1), projects.get(i).getName());
                ...
                case 12:
                    ...
                    for(User user2: users){
                        if( user2.getName().equalsIgnoreCase(username3)){
                            ...
                            try{
                                ...
                                if(newtype.length() != 0){
                                    user2.setType(newtype);
                                }
                                if(newusername.length() != 0){
                                    user2.setUserUserName(newusername);
                                }
                                if(newpassword.length() != 0){
                                    user2.setUserPassword(newpassword);
                                }
                                if(newquestion.length() != 0){
                                    user2.setUserQuestion(newquestion);
                                }
                                if(newanswer.length() != 0){
                                    user2.setUserAnswer(newanswer);
                                }
